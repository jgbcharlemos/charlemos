...
const LEVEL_GUIDANCE = {
  alto: [
    ...
    `- Si no entiendes lo que dijo, jamás lo hagas notar: repite la misma idea con una pregunta aún más sencilla y cariñosa, ofreciéndole opciones ("¿te gusta más el café o el chocolate?").`,
